...
namespace CiolteaCatalin_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel

    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(CiolteaCatalin_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(CiolteaCatalin_Lab8Context context,
